                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">
                                            <form action="fetch.file.php" method="GET" style="padding:0px;margin:0px;" target="_blank">
                                                ...
                                                <button type="submit" class="btn btn-light"  name="download" style="width:100%;height:100%;"><i class="fas fa-download"></i> <span class="sr-only">Descargar documento <?php echo $f['filename']; ?></span></button>
                                            </form>
                                        </td>
                                        <td scope="row">
