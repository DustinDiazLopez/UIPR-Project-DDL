        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                <?php if (isset($_SESSION['guest']) && $_SESSION['guest'] === FALSE) : ?>
                    <li class="nav-item">
                        <a class="nav-link" href="add.php"><i class="fas fa-plus-circle"></i> Add an Item</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="adminpanel.php"><i class="fas fa-tools"></i> Admin Panel</a>
                    </li>
                <?php endif; ?>
                ...
                <?php if (isset($_SESSION['guest']) && $_SESSION['guest'] === FALSE) : ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                           aria-haspopup="true" aria-expanded="false"><i class="fas fa-server"></i> Links</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" target="_blank" href="http://uipr.herokuapp.com/redir/userdoc.php"><i
                                        class="fas fa-user"></i> User Documentation</a>
                            <a class="dropdown-item" target="_blank"
                               href="http://uipr.herokuapp.com/redir/newissue.php"><i class="fas fa-bug"></i> Report a
                                Bug</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" target="_blank" href="http://uipr.herokuapp.com/redir/wiki.php"><i
                                        class="fas fa-book"></i> WIKI</a>
                            <a class="dropdown-item" target="_blank"
                               href="http://uipr.herokuapp.com/redir/releases.php"><i
                                        class="fas fa-cloud-download-alt"></i> Download the latest version</a>
                            <a class="dropdown-item" target="_blank" href="http://uipr.herokuapp.com/redir/code.php"><i
                                        class="fab fa-github"></i> Source Code</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" target="_blank"
                               href="http://uipr.herokuapp.com/redir/readme.php"><i class="fas fa-book-open"></i> README</a>
                            <a class="dropdown-item" target="_blank" href="http://uipr.herokuapp.com/redir/license.php"><i
                                        class="far fa-copyright"></i> License (<span
                                        style="font-family:courier new,courier,monospace; font-size:16px;">MIT</span>)</a>
                        </div>
                    </li>
                <?php endif; ?>
            </ul>
